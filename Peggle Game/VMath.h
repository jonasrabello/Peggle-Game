...
namespace MATH {
	...
	public:
		...
		/// Get the Direction between two Vec3s 
		static float Direction(const Vec3 &a, const Vec3 &b);

		/// Get the Direction between a point (Vec3) and a plane 
		static float Direction(const Vec3 &v, const Plane &p);

		/// Get the Direction between a sphere and a plane
		static float Direction(const Sphere &s, const Plane &p);
